...
export PYTHONPATH="${REPO_ROOT}/services/coordinator:${REPO_ROOT}/services/pierres_buying_tool:${REPO_ROOT}/services/tts-tool"
export PIERRES_BUYING_TOOL_URL="http://localhost:8002"
...
python -m uvicorn stardew_pierres_buying.app:app --port 8002 --log-level info &
OCR_PID=$!

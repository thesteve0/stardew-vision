...
TEMPLATES_DIR = Path(__file__).parents[1] / "services" / "pierres_buying_tool" / "assets" / "templates"
...
def test_parse_pierre_fields_structure():
    ...
    from stardew_pierres_buying.crop_pierres_detail_panel import parse_pierre_fields
...
def test_locate_panel_finds_match():
    ...
    import cv2
    from stardew_pierres_buying.crop_pierres_detail_panel import locate_panel
...
def test_extract_returns_required_keys():
    ...
    from stardew_pierres_buying.crop_pierres_detail_panel import crop_pierres_detail_panel_from_path
